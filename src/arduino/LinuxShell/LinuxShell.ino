...
/* this sketch is used to connect to the Galileo's linux shell
 * to go back to arduino mode, use the following commands in the shell:
 *
 * rm /sketch/sketch.elf
 * cp /etc/inittab.bak /etc/inittab
 * kill -SIGHUP 1
 * 
 * tutorial: https://learn.sparkfun.com/tutorials/galileo-getting-started-guide/using-the-terminal
 */
